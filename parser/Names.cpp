...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/20 18:22:45 by pschmunk          #+#    #+#             */
/*   Updated: 2025/10/21 19:13:03 by pschmunk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ACommand.hpp"

Names::Names(Server *server) : ACommand("NAMES", server) {}

void	Names::execute(Tokenizer *tokens) const
{
