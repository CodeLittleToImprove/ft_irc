...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/20 17:58:23 by pschmunk          #+#    #+#             */
/*   Updated: 2025/10/21 19:12:20 by pschmunk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ACommand.hpp"

Cnotice::Cnotice(Server *server) : ACommand("CNOTICE", server) {}

void	Cnotice::execute(Tokenizer *tokens) const
{
