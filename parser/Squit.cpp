...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/20 18:26:24 by pschmunk          #+#    #+#             */
/*   Updated: 2025/10/21 19:13:30 by pschmunk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ACommand.hpp"

Squit::Squit(Server *server) : ACommand("SQUIT", server) {}

void	Squit::execute(Tokenizer *tokens) const
{
